...
hl.bind(vars.kbLock, hl.dsp.exec_cmd(vars.caelestia_lock))
...
hl.bind(mod .. " + C", hl.dsp.exec_cmd("wl-copy"))
hl.bind(mod .. " + V", hl.dsp.exec_cmd("wl-paste"))
hl.bind(mod .. " + X", hl.dsp.exec_cmd("wl-cut"))
